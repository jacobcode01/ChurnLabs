...
- Evaluated 7 classification models including a DummyClassifier baseline, selecting Logistic Regression based on Recall, PR-AUC, and F1 score, with all experiments logged in MLflow with per-fold metrics and input data tracking.
